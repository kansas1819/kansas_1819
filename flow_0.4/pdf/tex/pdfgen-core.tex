...
local function _cschooltable(data)
   tex[#tex+1] = '\\startmycpar'
   tex[#tex+1] = '\\bTABLE[frame=off]'
   for i,v in ipairs(data) do
      tex[#tex+1] = '\\bTR '
...
local function genCover()
   ...
   tex[#tex+1] = '\\stopalignment'
   tex[#tex+1] = '\\startalignment[center]'                          
   tex[#tex+1] = 'Fill {\\bf Table 2} after the Assessment. Sign the sheet and place it at the top of the {\\bi Core Subjects} OMR bundle.\\hfill\\blank[2*big]'
