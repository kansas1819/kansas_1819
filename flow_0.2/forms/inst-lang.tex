...
for use only in {\bi emergency situations}. The buffer sheets are different for Classes (4,5)} and {\bi Classes (6,7,8,9,10)}. They are not interchangeable. Please ensure that the right buffer sheet is used.
The items {\bi a}, {\bi b}, and {\bi c} on the buffer sheet need to be filled properly.
