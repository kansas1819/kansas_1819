...
local function genCover()
   ...
   tex[#tex+1] = '\\startalignment[center]'            
   tex[#tex+1] = '{\\getbuffer[a]} \\blank {{\\bf Table 1~~} Enclosed Sheets}\\blank[2*big]'
   tex[#tex+1] = 'Fill {\\bf Table 2} after the Assessment. Sign the sheet and place it at the top of the {\\bi Languages} OMR bundle.\\blank'
   tex[#tex+1] = '\\getbuffer[b] \\blank \\noindent {\\bf Table 2~~} Filled  Sheets~~~~~\\blank'
   tex[#tex+1] = '\\stopalignment \n \\blank[1*big] \n'          
   --inspect(tex)
